...
public record EditStoreRequestDto(
        @NotBlank(message = "El NIT de la tienda no puede ser nulo ni vacio!") @Positive(message = "El NIT de la tienda debe ser positivo!") Long NIT,
